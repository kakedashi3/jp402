    ...
    <>
      <header className="hero hero-center">
        <div className="in">
          ...
          <p className="lede">
            JPYC（Polygon）で買える API・コンテンツ・商品を、<strong>ひとつの場所で</strong>。<br />
            掲載台帳は GitHub に公開、実績はチェーンが証明。<br />
            AI も人も、安心して選べる。
          </p>
          <HeroTerminal command={`curl ${apiUrl}`} />
      ...
      <main>
          ...
          {jpyc.length === 0 ? (
            <div className="empty">
              ...
              <p>
                ...
                自分のドメインに <code>/openapi.json</code>（有料 op に x-payment-info / x-jp402）を置いて URL を1行 PR するだけです。
              </p>
        ...
        <section id="agent" className="wrap">
          ...
          <CopyBlock label="エージェント用プロンプト" text={agentPrompt} tone="dark" />
        </section>
      </main>
    </>
  );
